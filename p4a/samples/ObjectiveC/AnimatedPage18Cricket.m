...
@interface AnimatedPage18Cricket ()
...
@implementation AnimatedPage18Cricket
...
- (CGPathRef)newRandomPathWithStartingPoint:(CGPoint)firstPoint
{
    ...
    for ( i = 1; i < count; i++)
    {
        ...
        if (i == 1 ) {
            x+=150;//random() % ((NSInteger)(self.bounds.size.width) + 50);
        } 
        y=firstPoint.y;
...
- (void)generateGlowingSphereLayer
{
    ...
    NSImage* compositeImage = [NSImage imageNamed:@"page18_19_cricket.png"];
