...
#import "AnimatedNote3.h"
#import <QuartzCore/QuartzCore.h>
#import "NSImage-Extras.h"

@interface AnimatedNote3 ()
...
- (CAAnimation*) rotationAnimation: (CGSize) size
{
    ...
    rotationAnimation.toValue = [NSNumber numberWithFloat:(M_PI)/13];
...
- (void)generateGlowingSphereLayer
{
    ...
    NSImage* compositeImage = [NSImage imageNamed:@"music notes-03.png"];
