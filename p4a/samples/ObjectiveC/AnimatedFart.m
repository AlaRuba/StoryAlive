...
- (void)generateGlowingSphereLayer
{
    ...
    NSImage* compositeImage = [NSImage imageNamed:@"page10_11_fart.png"];
    compositeImage = [self resize:compositeImage scale:0.9];
