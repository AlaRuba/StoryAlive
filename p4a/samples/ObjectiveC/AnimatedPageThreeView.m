...
@interface AnimatedPageThreeView ()
...
@implementation AnimatedPageThreeView
...
- (void)generateGlowingSphereLayer
{
    ...
    NSImage* compositeImage = [NSImage imageNamed:@"page3_4_fireflies.png"];
