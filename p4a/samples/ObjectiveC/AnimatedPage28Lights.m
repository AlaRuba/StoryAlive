...
@interface AnimatedPage28Lights ()
...
@implementation AnimatedPage28Lights
...
- (void)generateGlowingSphereLayer
{
    ...
    NSImage* compositeImage = [NSImage imageNamed:@"page28_29_lights.png"];
    compositeImage = [self resize:compositeImage scale:.98];
